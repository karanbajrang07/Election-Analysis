...
country_list = pc.read_country_data('data/Association-Matrix/','Delhiwt.xlsx')
matrix = pc.read_association_matrix_shifted('data/Association-Matrix/','DelhiMat.xlsx') #persuation power matrix
...
quota = [int(net_sum[0] * .74), int(net_sum[1] * .62), 0]# fix for politicos, all quotas other than weight are zero.
